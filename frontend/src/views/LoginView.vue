        ...
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="mb-6 text-gray-500">
                    neangime - social network developed as part of the "Internet Technologies" course. This platform is created using the Django and Vue frameworks.
                    The project aims to develop skills in the field of web development and interaction with modern technologies.
                </p>
                <p class="text-gray-500">
                    Completed by - Zhetpis A.Zh.
                </p>
                <p class="mb-6 text-gray-500">
                    Project Supervisor - Kabdulin M.A.
                </p>
                <p class="mb-6 text-gray-500">
                    Autumn 2023 - 2024. Satbayev University
                </p>
